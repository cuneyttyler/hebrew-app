...
app.on('ready', async () => {
    ...
    ipcMain.on('book_request', async (_, sectionIndex, bookIndex) => {
        ...
        if(sectionIndex == 0) {
            switch(bookIndex) {
                case 0: book = 'genesis'; break;
                case 1: book = 'exodus'; break;
                case 2: book = 'leviticus'; break;
                case 3: book = 'numbers'; break;
                case 4: book = 'deuteronomy'; break;
            }
        } else if(sectionIndex == 1) {
            switch(bookIndex) {
                case 0: book = 'joshua'; break;
                case 1: book = 'judges'; break;
                case 2: book = 'samuel_I'; break;
                case 3: book = 'samuel_II'; break;
                case 4: book = 'kings_I'; break;
                case 5: book = 'kings_II'; break;
                case 6: book = 'isaiah'; break;
                case 7: book = 'jeremiah'; break;
                case 8: book = 'ezekiel'; break;
            }
        } else if(sectionIndex == 2) {
            switch(bookIndex) {
                case 0: book = 'hosea'; break;
                case 1: book = 'joel'; break;
                case 2: book = 'amos'; break;
                case 3: book = 'obadiah'; break;
                case 4: book = 'jonah'; break;
                case 5: book = 'micah'; break;
                case 6: book = 'nahum'; break;
                case 7: book = 'habakkuk'; break;
                case 8: book = 'zephaniah'; break;
                case 9: book = 'haggai'; break;
                case 10: book = 'zechariah'; break;
                case 11: book = 'malachi'; break;
            }
        } else if(sectionIndex == 3) {
            switch(bookIndex) {
                case 0: book = 'psalms'; break;
                case 1: book = 'proverbs'; break;
                case 2: book = 'job'; break;
                case 3: book = 'song_of_songs'; break;
                case 4: book = 'ruth'; break;
                case 5: book = 'lamentations'; break;
                case 6: book = 'ecclesiastes'; break;
                case 7: book = 'esther'; break;
                case 8: book = 'daniel'; break;
                case 9: book = 'ezra'; break;
                case 10: book = 'nehemiah'; break;
                case 11: book = 'chronicles_I'; break;
                case 12: book = 'chronicles_II'; break;
            }
        }
    ...
    ipcMain.on('verse_request', async (_, verseIndex) => {
        ...
        switch(parseInt(verseIndex[0])) {
            case 1: file = 'pantateuch_data.csv'; break;
            case 2: file = 'prophets_data.csv'; bookIndex = parseInt(verseIndex[1]) + 5; break;
            case 3: file = 'minor_prophets_data.csv'; bookIndex = parseInt(verseIndex[1]) + 14;  break;
            case 4: file = 'writings_data.csv'; bookIndex = parseInt(verseIndex[1]) + 26; break;
        }
